...
import javax.swing.JFileChooser; // Add this import statement
...
public class colorchooser {
    public static void main(String[] args) {
        ...
        // Membuat instance objek JButton untuk JColorChooser
        JButton colorChooserButton = new JButton("Pilih Warna");
        colorChooserButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                // Membuat instance objek JColorChooser
                Color color = JColorChooser.showDialog(frame, "Pilih Warna", Color.WHITE);
                if (color != null) {
                    // Mengubah latar belakang panel menjadi warna yang dipilih
        ...
        // JButton JToolTipExample, JTree, dan JButton JColorChooser ke dalam JFrame
        ...
        // Menentukan ukuran dan posisi JTree
        treeScrollPane.setBounds(320, 130, 100, 100);

        // Menentukan ukuran dan posisi JButton JColorChooser
        colorChooserButton.setBounds(10, 670, 150, 30);
