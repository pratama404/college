...
public class Jtree {
    public static void main(String[] args) {
        ...
        // Menambahkan ActionListener ke JButton JToolTipExample
        toolTipButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(frame, "Ini adalah tombol dengan tooltip");
            }
        });
        ...
        // JButton JToolTipExample, dan JTree ke dalam JFrame
