...
public class KeyListenerPratama {
    public static void main(String[] args) {
        ...
        // Menambahkan MouseListener dan KeyListener ke tombol
        ...
        // Fokus pada tombol agar dapat mendeteksi input keyboard
...
class MyKeyListener implements KeyListener {
    public void keyPressed(KeyEvent e) {
        ...
        System.out.println("Tombol dengan kode " + keyCode + " ditekan.");
    }

    public void keyReleased(KeyEvent e) {
        int keyCode = e.getKeyCode();
        System.out.println("Tombol dengan kode " + keyCode + " dilepas.");
    }

    public void keyTyped(KeyEvent e) {
        char keyChar = e.getKeyChar();
        System.out.println("Karakter " + keyChar + " diketikkan.");
    }
}
