...
public class PratamaCaretListener extends JFrame {
    private JTextField textField;
    private JScrollBar verticalScrollBar;
    private JTextArea textArea;

    public PratamaCaretListener() {
        ...
        textArea.getDocument().addDocumentListener(new DocumentListenerPratama());
    ...
    private class DocumentListenerPratama implements DocumentListener {
        @Override
    ...
    private class MyCaretListener implements CaretListener {
        ...
        public void caretUpdate(CaretEvent e) {
            ...
            JOptionPane.showMessageDialog(null, "Posisi caret: " + caretPosition);
        }
    }

    public static void main(String[] args) {
        new PratamaCaretListener();
    }
}
